...
brew "choosy" # Browser chooser utility
brew "cmake" # Cross-platform build system
brew "composer" # PHP dependency manager
brew "dark-mode" # Control macOS dark mode from CLI
...
brew "gdbm" # GNU database manager library
brew "gh" # GitHub command line tool
brew "git" # Distributed version control system
brew "git-extras" # Extra Git utilities
brew "glib" # Core application building blocks for GNOME
...
brew "libxml2" # XML parsing library
brew "libyaml" # YAML parsing library
brew "markdownlint-cli" # Markdown linting tool
...
brew "planetscale/tap/pscale" # PlanetScale database CLI
brew "postgresql" # Object-relational database system
brew "pygments" # Syntax highlighting library
brew "rcm" # Dotfile management tool
brew "re2" # Regular expression library
...
brew "stripe/stripe-cli/stripe" # Stripe command line tool
brew "tcl-tk" # Tcl/Tk scripting language
...
cask "kindlegen" # E-book conversion tool
cask "launchcontrol" # LaunchAgent and LaunchDaemon manager
